...
<section class="section">
    <div class="container container-tight">
        ...
        <p>Support questions, feature requests, content corrections — we read every message and reply within one business day.</p>
        ...
        <form method="post" action="/contact" class="card" style="margin-top:24px;">
            ...
            <div class="form-group">
                ...
                <textarea class="form-textarea" id="message" name="message" rows="6" required minlength="10" style="font-family:inherit;"></textarea>
